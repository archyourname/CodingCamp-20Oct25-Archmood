...
if(tokenCoin){
    ...
    function updateTokenParallax(){
        ...
        tokenCoin.style.marginLeft =
            `${tokenCoinPos.x}px`;

        tokenCoin.style.marginTop =
            `${tokenCoinPos.y}px`;
...
const vdpForm =
    document.getElementById("vdpForm");
         ...
         function(event){
             ...
             setTimeout(
                 function(){
                     ...
                     submitButton.innerHTML =
                         'SUBMIT SECURITY REPORT <span>→</span>';
